...
Source Server         : data.pollylee.cn
Source Server Version : 50719
Source Host           : data.pollylee.cn:3306
Source Database       : test_tpblog_cn
...
INSERT INTO `blog_config` VALUES ('37', 'SiteName', 'blog', 'string', 'PHP社区 - 国内专业IT技术社区', '站点名称', '0', '2019-01-02 17:11:57', '0', null, null);
...
INSERT INTO `blog_config` VALUES ('39', 'SiteDescription', 'blog', 'string', 'PHP社区是一个面向开发者的知识分享社区。自创建以来，PHP社区一直致力并专注于为开发者打造一个纯净的技术交流社区，推动并帮助开发者通过互联网分享知识，从而让更多开发者从中受益。PHP社区的使命是帮助开发者用代码改变世界。', '站点描述', '0', '2019-01-02 17:13:25', '0', null, null);
INSERT INTO `blog_config` VALUES ('40', 'SiteUsername', 'blog', 'string', 'Libo', '站长姓名', '0', '2019-01-02 17:38:39', '0', null, null);
INSERT INTO `blog_config` VALUES ('41', 'SiteJob', 'blog', 'string', 'PHP程序员', '站长职业', '0', '2019-01-02 17:38:49', '0', null, null);
INSERT INTO `blog_config` VALUES ('42', 'SiteEmail', 'blog', 'string', 'libo@usa.com', '站长邮箱', '0', '2019-01-02 17:39:00', '0', null, null);
...
INSERT INTO `blog_member` VALUES ('12', '', '测试2', 'ceshi2', 'ed696eb5bba1f7460585cc6975e6cf9bf24903dd', 'https://static.pollylee.cn/817665ed87824a76af9b997081d87cf7.jpg', '15521045869', '', null, '0', null, null, '', '', null, '', '0', '0', '0', '2018-10-17 01:47:35', '0', null, null);
...
-- ----------------------------
INSERT INTO `blog_slider` VALUES ('1', '轮播图1', 'https://static.pollylee.cn/slide1.jpg', 'https://www.baidu.com', '_blank', '3', null, '0', '2018-08-10 16:17:20', null, null, null);
INSERT INTO `blog_slider` VALUES ('2', '轮播图2', 'https://static.pollylee.cn/slide2.jpg', 'https://www.pollylee.cn', '_blank', '2', null, '0', '2018-08-10 16:17:42', null, null, null);
INSERT INTO `blog_slider` VALUES ('3', '轮播图3', 'https://static.pollylee.cn/slide3.jpg', 'admin/auth/index', '_blank', '0', '', '0', '2018-08-10 16:53:18', '0', null, null);
...
INSERT INTO `system_config` VALUES ('47', 'FileKey', 'file', 'string', '690c7175d2b4439646b437b8b48f92fb147eccf0', '文件路径加密秘钥（www.pollylee.cn）', '0', '2018-09-17 16:51:29', '0', null, null);
...
INSERT INTO `system_config` (`name`, `group`, `type`, `value`, `remark`, `sort`, `create_at`, `create_by`, `update_at`, `update_by`) VALUES ('spider_url', 'spider', 'string', 'http://spider.pollylee.cn/api/article/index.html', '采集接口地址', '0', '2018-11-19 10:46:46', '0', NULL, NULL);
